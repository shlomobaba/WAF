...
class ProxyHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def riskDetector(self,potentialAttack):
        ...
        if (riskScore >= riskLevel.MEDIUM_RISK):
            #print("Potentail attack:" + str(potentialAttack )+ " Risk: " + str(riskScore))
...
def parse_args(argv=sys.argv[1:]):
    ...
    parser.add_argument('--port', dest='port', type=int, default=51234,
                        help='serve HTTP requests on specified port (default: random)')
    parser.add_argument('--hostname', dest='hostname', type=str, default='127.0.0.1:8080/DVWA',
